...
kfnt = ImageFont.truetype('/Library/Fonts/SF-Pro-Display-Bold.otf', 18)
...
for letter in letters:
    ...
    for dirname, bgcolor in key_bgs:
        img = Image.new('RGB', (36, 60), color=bgcolor)
        d = ImageDraw.Draw(img)
        d.text((18, 40), letter, font=kfnt, fill=(255, 255, 255), align='center', anchor='mb')
